...
echo -e " \033[32;5mStep 1 Bootstrap First k3s Node\033[0m"
...
echo -e " \033[32;5mStep 2 install Kube-VIP for HA\033[0m"
...
echo "put kube-vip.yaml" > sftp_commands.txt
echo "quit" >> sftp_commands.txt

if ! sftp -b "sftp_commands.txt" $user@$master1; then
    echo "SFTP transfer failed" >&2
    exit 1
fi

echo -e " \033[32;5mStep 5 Connect to Master1 and move kube-vip.yaml\033[0m"
...
echo -e " \033[32;5mStep 6 Add new master nodes (servers) & workers\033[0m"
...
echo -e " \033[32;5mAdding Worker Nodes\033[0m"
# add workers
...
echo -e " \033[32;5mStep 7 Install kube-vip as network LoadBalancer - Install the kube-vip Cloud Provider\033[0m"
# Step 7: Install kube-vip as network LoadBalancer - Install the kube-vip Cloud Provider
kubectl apply -f https://raw.githubusercontent.com/kube-vip/kube-vip-cloud-provider/main/manifest/kube-vip-cloud-controller.yaml

echo -e " \033[32;5mStep 8 Install Metallb\033[0m"
...
echo -e " \033[32;5mStep 9 Installing Test with Nginx\033[0m"
...
echo -e " \033[32;5mStep 10 Deploy IP Pools and l2Advertisement\033[0m"
